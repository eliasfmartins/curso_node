...
(0, vitest_1.describe)('Transactions routes', () => {
    ...
    (0, vitest_1.it)('should be  able  to create a new trasaction', async () => {
    ...
    (0, vitest_1.it)('should be able list all transactions', async () => {
        const createTransactionResponse = await (0, supertest_1.default)(server_1.app.server)
            .post('/transactions')
            .send({
            title: 'New transaction',
            amount: 5000,
        ...
        const listTransactionsReponse = await (0, supertest_1.default)(server_1.app.server)
            .get('/transactions')
            .set('Cookie', cookies)
            .expect(200);
    ...
    (0, vitest_1.it)('should be able to get a specific transaction', async () => {
        ...
        const getTransactionResponse = await (0, supertest_1.default)(server_1.app.server)
    ...
    (0, vitest_1.it)('should be able  to get the summary', async () => {
        ...
        const cookies = createTransactionResponse.get('Set-Cookie');
        await (0, supertest_1.default)(server_1.app.server)
            .post('/transactions')
            .set('Cookie', cookies)
            .send({
        ...
        const summaryResponse = await (0, supertest_1.default)(server_1.app.server)
